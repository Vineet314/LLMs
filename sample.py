...
def main(args):
    """Main function to load the model and generate text using tiktoken."""
    ...
    with torch.no_grad():
        # The generate function is part of your LLM class
        a = perf_counter()
        y = model.generate(x,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--temperature',    type=float, default=0.8,            help='Generation temperature. >1.0 for more creative, <1.0 for more deterministic.')
